#ifndef TESTMORPHOGEN_HPP_
#define TESTMORPHOGEN_HPP_
...
static const double M_TIME_FOR_SIMULATION = 100;
static const double M_NUM_CELLS_ACROSS = 10;
static const double M_UPTAKE_RATE = 0.01;
static const double M_DIFFUSION_CONSTANT = 1e-4;
static const double M_DUDT_COEFFICIENT = 1.0;

class TestMorphogen : public AbstractCellBasedWithTimingsTestSuite
{
private:

    // Helper method to generate cells and is used in all simulations
    void GenerateCells(unsigned num_cells, std::vector<CellPtr>& rCells)
    {
        ...
        for (unsigned i=0; i<num_cells; i++)
        {
            ...
            // Set target area (so don't need to use a growth model in vertex model example)
...
public:
    ...
    void TestCaBasedMorphogen() throw (Exception)
    {
        // Create a suitable mesh object
        ...
        // Specify what data to output to results files
        ...
        // Add a lattice site switching update rule (to smooth out the edge of the monolayer)
    ...
    void TestPottsBasedMorphogen() throw (Exception)
    {
        // Create a suitable mesh object
    ...
    void TestMeshBasedMorphogen() throw (Exception)
    {
        // Create a suitable mesh object
    ...
    // Vertex model
    void TestVertexBasedMorphogen() throw (Exception)
    {
        // Create a suitable mesh object
        ...
        // Create a force object and pass to the simulation
