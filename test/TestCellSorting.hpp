...
static const double M_TIME_TO_STEADY_STATE = 10;
static const double M_TIME_FOR_SIMULATION = 100;
static const double M_NUM_CELLS_ACROSS = 20;
...
private:
    ...
    // Helper method to randomly label cells add is used in all simulations
...
public:
    ...
    void TestCaBasedCellSorting() throw (Exception)
    {
        ...
        // Add a lattice site switching update rule
        ...
        // Run the simulation for an initial period
        simulator.Solve();
        ...
        // Run simulation for a further period
        simulator.SetEndTime(M_TIME_TO_STEADY_STATE + M_TIME_FOR_SIMULATION);
        simulator.Solve();
    }

    // Cellular Potts model example
    void TestPottsCellSorting() throw (Exception)
    {
        // Create a suitable mesh object
        ...
        // Set the temperature
        cell_population.SetTemperature(0.2); // Default value is 0.1
    ...
    // Overlapping spheres example
    void TestNodeBasedCellSorting() throw (Exception)
    {
        // Create a suitable mesh object
    ...
    void TestMeshBasedWithGhostsCellSorting() throw (Exception)
    {
        // Create a suitable mesh object
    ...
    // Vertex model example
    void TestVertexCellSorting() throw (Exception)
    {
        // Create a suitable mesh object
